...
(defconst dtd-xml-keyword-list-1-pound
  (list
...
(defconst dtd-xml-keyword-list-3
  (append
   ...
   (list
    "ANY" "ATTLIST" "CDATA" "DOCTYPE" "DTD" "ELEMENT" "EMPTY"
    "ENTITIES" "ENTITY" "ID" "IDREF" "IDREFS" "INCLUDE" "IGNORE"
  ...
  (append
   ...
   (list
    ...
    (list
     (concat
      "\\b"
      (regexp-opt dtd-xml-keyword-list-2 t)
      "\\b")
     (list 1 font-lock-type-face))
    ...
    (list
     (concat
      "\\b"
      (regexp-opt dtd-xml-keyword-list-3 t)
      "\\b")
     (list 1 font-lock-type-face))
    )
